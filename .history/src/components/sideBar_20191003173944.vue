<template>
<v-card  class="left-sidebar" :class="{active: active}"  height="100%">
    <v-navigation-drawer
    permanents
    width="100%"
    height="100%"
    ...
    <template v-slot:prepend>
        ...
        <v-list-item
            ...
            <v-list-item-content>
                <v-list-item-title class="title"><router-link to="/manager/profile">{{user.USERNAME}}</router-link> </v-list-item-title>
    ...
    <v-list
        ...
        dense
    >
    <v-list-item link to="/manager/dashboard"> 
        <v-list-item-icon>
            <v-icon>mdi-view-dashboard</v-icon>
        </v-list-item-icon>
        <v-list-item-title>Dashboard</v-list-item-title>
    </v-list-item>
        <v-list-item link to="/manager/folders">
            <v-list-item-icon>
