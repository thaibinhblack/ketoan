...
export default {
    ...
    methods:
    {
        ...
        DownloadFile(file)
        {
            const url = window.URL.createObjectURL(new Blob([$store.state.PUBLIC_URL + file.YEAR_FOLDER+'/'+file.FOLDER_FILE+'/'+file.TYPE_FILE+'/'+file.MONTH_FOLDER+'/'+file.NAME_FILE]))
