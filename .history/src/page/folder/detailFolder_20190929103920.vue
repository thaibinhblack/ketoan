    ...
    <v-row>
        ...
        <v-col cols="12" sm="8">
            <ul class="list-link">
                ...
                <li v-for="(link,index) in list_folder" :key="index" @click="folder_filter = link"><v-icon>mdi-chevron-right</v-icon> <v-icon>mdi-folder-open</v-icon> Thư mục {{link.NAME_FOLDER}}</li>
            </ul>
        </v-col>
