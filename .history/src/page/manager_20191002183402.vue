            ...
            <div class="maincontent">
                ...
                <div class="list-notify">
                    <ul class="ul-notify">
                        ...
                        <li v-for="(notify,i) in notifyData.data" :key="i">{{notify.NAME_FOLDER}}</li>
                    </ul>
                </div>
                <div id="layout-main">
...
.ul-notify {background: #e2e2e2;border:1px solid #e2e2e2;padding-left: 0;width: 300px;max-height: 100%;z-index: 999;}
.ul-notify li {list-style: none;text-align: left;padding: 15px;background: #fff;border: 1px solid #e2e2e2;border-bottom: none}
.ul-notify li:first-child {background: #eeeeee;}
